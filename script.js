const products = [
  ...
  { id: 'ruby-chandbalis', name: 'Ruby bloom chandbalis', category: 'Earrings', detail: 'Rose-red resin · Kundan & pearl drops', image: 'photos/ruby-chandbali-earrings.webp', alt: 'Rose-red resin chandbali earrings framed in kundan crystals with pearl drops', tag: 'BRIDAL EDIT' },
  ...
  { id: 'petal-clutch', name: 'Personalised petal clutch', category: 'Accessories', detail: 'Your name in gold · Rose petals & gold leaf', image: 'photos/petal-name-clutch.webp', alt: 'A resin clutch bag filled with rose petals and gold leaf, with the name Khushi in gold', tag: 'CARRY YOUR NAME' },
