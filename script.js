const products = [
  ...
  { id: 'pink-jhumkas', name: 'Pink bloom jhumkas', category: 'Earrings', detail: 'Pressed petals · Pearl & bell drops', price: 899, image: 'photos/pink-bloom-jhumkas.webp', alt: 'Pink resin jhumka earrings with pressed petals, pearls and purple bell drops', tag: 'FESTIVE FAVOURITE' },
  ...
  { id: 'teal-hearts', name: 'Teal heart earrings', category: 'Earrings', detail: 'Shimmer resin · Antique-gold studs', price: 599, image: 'photos/teal-heart-earrings.webp', alt: 'Teal shimmer resin heart earrings with antique-gold studs', tag: 'ALL HEART' },
  ...
  { id: 'ring', name: 'Royal blue filigree ring', category: 'Rings & bracelets', detail: 'Adjustable · Antique filigree', price: 549, image: 'photos/filigree-ring.webp', alt: 'A royal-blue resin ring in an antique filigree setting, held among bougainvillea', tag: 'STATEMENT PIECE' },
  { id: 'sunflower', name: 'Sunflower pendant', category: 'Necklaces', detail: 'Real pressed sunflower · Gold chain', price: 749, image: 'photos/sunflower-pendant.webp', alt: 'A gold pendant preserving a bright yellow sunflower in resin', tag: 'SUNSHINE, KEPT' },
  { id: 'blossom-globes', name: 'Blossom globe earrings', category: 'Earrings', detail: 'Blue-kissed glass globes', price: 549, image: 'photos/blossom-globe-earrings.webp', alt: 'Glass globe drop earrings with blue resin, hanging from a cherry-blossom branch', tag: 'SOFT AS SPRING' },
  { id: 'rose-locket', name: 'Rose locket necklace', category: 'Necklaces', detail: 'Pressed rose petals · Gold chain', price: 749, image: 'photos/rose-locket-necklace.webp', alt: 'A gold locket holding pressed red rose petals in resin', tag: 'IT WAS NEVER JUST A ROSE' },
  ...
  { id: 'butterfly-keychain', name: 'Butterfly & rose keychain', category: 'Keychains', detail: 'Rose petals · Red butterfly charm', price: 449, image: 'photos/butterfly-rose-keychain.webp', alt: 'A red resin keychain with pressed rose petals and a red butterfly charm', tag: 'LOVE, CARRIED' },
  ...
  { id: 'photo-clock', name: 'Personalised photo clock', category: 'Keepsakes', detail: 'Your photos & names · Made to order', price: 1999, image: 'photos/photo-clock.webp', alt: 'A round black glitter resin wall clock set with family photos and names', tag: 'EVERY HOUR, TOGETHER' },
